...
import { extractEventHandlers } from "./chunk-63CT3VCP.js";
import {
  HTMLElementType,
...
var Portal = React2.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(
    React2.isValidElement(children) ? children.ref : null,
    forwardedRef,
  );
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
function useModal(parameters) {
  ...
  const isTopModal = React3.useCallback(
...
export { FocusTrap, Portal, ModalManager, useModal };
//# sourceMappingURL=chunk-BU6YDZZD.js.map
