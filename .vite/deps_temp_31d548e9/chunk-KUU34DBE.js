...
function useMediaQuery(queryInput, options = {}) {
  ...
  const useMediaQueryImplementation =
    maybeReactUseSyncExternalStore !== void 0
      ? useMediaQueryNew
      : useMediaQueryOld;
...
function GlobalStyles2({ styles, themeId, defaultTheme: defaultTheme4 = {} }) {
...
function resolveTheme({ defaultTheme: defaultTheme4, theme, themeId }) {
...
function createStyled(input = {}) {
  ...
  return (tag, inputOptions = {}) => {
    internal_processStyles(tag, (styles) =>
      styles.filter((style2) => !(style2 != null && style2.__mui_systemSx)),
    );
    const {
        name: componentName,
        slot: componentSlot,
...
function RtlProvider(_ref) {
  let { value } = _ref,
    props = _objectWithoutPropertiesLoose(_ref, _excluded4);
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React10.useCallback(
    (mode) => {
  ...
  const handleMediaQuery = React10.useCallback(
    (event) => {
...
function createCssVarsProvider(options) {
  ...
  if (
    !defaultTheme4.colorSchemes ||
    (typeof designSystemColorScheme === "string" &&
      !defaultTheme4.colorSchemes[designSystemColorScheme]) ||
  ...
  function CssVarsProvider(props) {
    ...
    const _ref = scopedTheme || themeProp,
      ...
      restThemeProp = _objectWithoutPropertiesLoose(_ref, _excluded5);
    ...
    const element = (0, import_jsx_runtime8.jsxs)(React11.Fragment, {
      children: [
        shouldGenerateStyleSheet &&
          (0, import_jsx_runtime8.jsxs)(React11.Fragment, {
            children: [
  ...
  true
    ? (CssVarsProvider.propTypes = {
         ...
         */
        defaultColorScheme: import_prop_types6.default.oneOfType([
...
function prepareCssVars(theme, parserConfig) {
  const { colorSchemes = {}, defaultColorScheme = "light" } = theme,
    otherTheme = _objectWithoutPropertiesLoose(theme, _excluded6);
  const {
    vars: rootVars,
    css: rootCss,
  ...
  const { [defaultColorScheme]: light } = colorSchemes,
    otherColorSchemes = _objectWithoutPropertiesLoose(
      colorSchemes,
      [defaultColorScheme].map(toPropertyKey),
    );
  ...
  const generateCssVars = (colorScheme) => {
    ...
    if (!colorScheme) {
      ...
      return {
        ...
        selector:
          (parserConfig == null ||
          (_parserConfig$getSele = parserConfig.getSelector) == null
            ? void 0
            : _parserConfig$getSele.call(parserConfig, colorScheme, css3)) ||
          ":root",
      };
    }
    ...
    return {
      ...
      selector:
        (parserConfig == null ||
        (_parserConfig$getSele2 = parserConfig.getSelector) == null
          ? void 0
          : _parserConfig$getSele2.call(parserConfig, colorScheme, css2)) ||
        ":root",
    };
  };
  return {
...
var useThemePropsDefault = (inProps) =>
  useThemeProps({
    props: inProps,
    name: "MuiContainer",
    defaultTheme,
...
function createContainer(options = {}) {
  ...
  true
    ? (Container2.propTypes = {
        ...
        maxWidth: import_prop_types7.default.oneOfType([
...
true
  ? (Container.propTypes = {
       ...
       * @default 'lg'
       */
      maxWidth: import_prop_types8.default.oneOfType([
        import_prop_types8.default.oneOf(["xs", "sm", "md", "lg", "xl", false]),
...
var filterBreakpointKeys = (breakpointsKeys, responsiveKeys) =>
...
function createGrid(options = {}) {
  ...
  const Grid2 = React13.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime10.jsx)(
      GridRoot,
      _extends(
        {
          ref,
  ...
  true
    ? (Grid2.propTypes = {
        ...
        columns: import_prop_types9.default.oneOfType([
          import_prop_types9.default.arrayOf(import_prop_types9.default.number),
          import_prop_types9.default.number,
          import_prop_types9.default.object,
        ]),
        columnSpacing: import_prop_types9.default.oneOfType([
        ...
        direction: import_prop_types9.default.oneOfType([
        ...
        lg: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
          import_prop_types9.default.bool,
        ]),
        lgOffset: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
        ]),
        md: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
          import_prop_types9.default.bool,
        ]),
        mdOffset: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
        ]),
        rowSpacing: import_prop_types9.default.oneOfType([
          import_prop_types9.default.arrayOf(
            import_prop_types9.default.oneOfType([
              import_prop_types9.default.number,
              import_prop_types9.default.string,
        ...
        sm: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
          import_prop_types9.default.bool,
        ]),
        smOffset: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
        ]),
        spacing: import_prop_types9.default.oneOfType([
          import_prop_types9.default.arrayOf(
            import_prop_types9.default.oneOfType([
              import_prop_types9.default.number,
              import_prop_types9.default.string,
        ...
        wrap: import_prop_types9.default.oneOf([
          "nowrap",
          "wrap-reverse",
          "wrap",
        ]),
        xl: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
          import_prop_types9.default.bool,
        ]),
        xlOffset: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
        ]),
        xs: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
          import_prop_types9.default.bool,
        ]),
        xsOffset: import_prop_types9.default.oneOfType([
          import_prop_types9.default.oneOf(["auto"]),
          import_prop_types9.default.number,
        ]),
      })
...
true
  ? (Grid.propTypes = {
       ...
       * @default 12
       */
      columns: import_prop_types10.default.oneOfType([
        import_prop_types10.default.arrayOf(import_prop_types10.default.number),
       ...
       */
      columnSpacing: import_prop_types10.default.oneOfType([
       ...
       * @default 'row'
       */
      direction: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf([
          "column-reverse",
          "column",
          "row-reverse",
          "row",
       ...
       * @default false
       */
      lg: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
       ...
       * The value is applied for the `lg` breakpoint and wider screens if not overridden.
       */
      lgOffset: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
      ]),
      /**
       ...
       * @default false
       */
      md: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
        import_prop_types10.default.bool,
      ]),
       ...
       * The value is applied for the `md` breakpoint and wider screens if not overridden.
       */
      mdOffset: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
      ]),
      /**
       ...
       * It overrides the value of the `spacing` prop.
       */
      rowSpacing: import_prop_types10.default.oneOfType([
        import_prop_types10.default.arrayOf(
          import_prop_types10.default.oneOfType([
            import_prop_types10.default.number,
            import_prop_types10.default.string,
       ...
       * @default false
       */
      sm: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
        import_prop_types10.default.bool,
      ]),
       ...
       * The value is applied for the `sm` breakpoint and wider screens if not overridden.
       */
      smOffset: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
      ]),
      /**
       ...
       * @default 0
       */
      spacing: import_prop_types10.default.oneOfType([
        import_prop_types10.default.arrayOf(
          import_prop_types10.default.oneOfType([
            import_prop_types10.default.number,
            import_prop_types10.default.string,
       ...
       * @default 'wrap'
       */
      wrap: import_prop_types10.default.oneOf([
        "nowrap",
        "wrap-reverse",
        "wrap",
      ]),
       ...
       * @default false
       */
      xl: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
        import_prop_types10.default.bool,
      ]),
       ...
       * The value is applied for the `xl` breakpoint and wider screens if not overridden.
       */
      xlOffset: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
      ]),
      /**
       ...
       * @default false
       */
      xs: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
        import_prop_types10.default.bool,
      ]),
       ...
       */
      xsOffset: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(["auto"]),
        import_prop_types10.default.number,
      ]),
    })
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(
        React14.cloneElement(separator, {
          key: `separator-${index}`,
        }),
      );
    }
...
function createStack(options = {}) {
  ...
  true
    ? (Stack2.propTypes = {
        ...
        direction: import_prop_types11.default.oneOfType([
        ...
        spacing: import_prop_types11.default.oneOfType([
          import_prop_types11.default.arrayOf(
...
true
  ? (Stack.propTypes = {
       ...
       * @default 'column'
       */
      direction: import_prop_types12.default.oneOfType([
       ...
       * @default 0
       */
      spacing: import_prop_types12.default.oneOfType([
        import_prop_types12.default.arrayOf(
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KUU34DBE.js.map
