...
import { useSlotProps } from "./chunk-63CT3VCP.js";
...
var BadgeBadge = styled_default("span", {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [
      ...
      styles[
        `anchorOrigin${capitalize_default(ownerState.anchorOrigin.vertical)}${capitalize_default(ownerState.anchorOrigin.horizontal)}${capitalize_default(ownerState.overlap)}`
      ],
    ...
    variants: [
      ...Object.keys(
        ...
        .filter((key) => {
          ...
          return (
            ((_theme$vars2 = theme.vars) != null ? _theme$vars2 : theme)
              .palette[key].main &&
            ((_theme$vars3 = theme.vars) != null ? _theme$vars3 : theme)
              .palette[key].contrastText
          );
        })
        .map((color) => ({
          props: {
...
true
  ? (Badge.propTypes = {
      ...
      variant: import_prop_types.default.oneOfType([
        import_prop_types.default.oneOf(["dot", "standard"]),
        import_prop_types.default.string,
      ]),
    })
  : void 0;
...
//# sourceMappingURL=chunk-HZRYUUPP.js.map
