...
import { require_react_dom } from "./chunk-YUNTBJI6.js";
import { useBadge } from "./chunk-3J7HX7FP.js";
import {
  areArraysEqual,
...
import { GlobalStyles_default } from "./chunk-KUU34DBE.js";
import {
  HTMLElementType,
  chainPropTypes,
  debounce,
...
var badgeClasses = generateUtilityClasses2(COMPONENT_NAME, [
  "root",
  "badge",
  "invisible",
]);
...
var Badge = React.forwardRef(function Badge2(props, forwardedRef) {
  ...
  const BadgeComponent =
    (_slots$badge = slots.badge) != null ? _slots$badge : "span";
...
var buttonClasses = generateUtilityClasses2(COMPONENT_NAME2, [
  "root",
  "active",
  "disabled",
  "focusVisible",
...
var Button = React3.forwardRef(function Button2(props, forwardedRef) {
  ...
  const Root =
    (_slots$root = slots.root) != null ? _slots$root : defaultElement;
  const rootProps = useSlotProps({
    elementType: Root,
...
true
  ? (Button.propTypes = {
       ...
       */
      action: import_prop_types2.default.oneOfType([
...
true
  ? (ClickAwayListener.propTypes = {
       ...
       * @default 'onClick'
       */
      mouseEvent: import_prop_types3.default.oneOf([
        "onClick",
        "onMouseDown",
        "onMouseUp",
        "onPointerDown",
       ...
       * @default 'onTouchEnd'
       */
      touchEvent: import_prop_types3.default.oneOf([
        "onTouchEnd",
        "onTouchStart",
        false,
      ]),
...
function useControllableReducer(parameters) {
  ...
  if (true) {
    React6.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
        if (
          controlledPropsRef.current[key] !== void 0 &&
          controlledProps[key] === void 0
        ) {
          console.error(
  ...
  const reducerWithControlledState = React6.useCallback(
    (state, action) => {
  ...
  const [nextState, dispatch] = React6.useReducer(
    reducerWithControlledState,
    initialState,
  );
  const dispatchWithContext = React6.useCallback(
    (action) => {
      dispatch(
        _extends({}, action, {
...
function useDropdown(parameters = {}) {
  ...
  const handleStateChange = React7.useCallback(
  ...
  const controlledProps = React7.useMemo(
    () =>
      openProp !== void 0
        ? {
            open: openProp,
...
var formControlClasses = generateUtilityClasses2(COMPONENT_NAME3, [
  "root",
  "disabled",
  "error",
  "filled",
...
var FormControl = React10.forwardRef(
  function FormControl2(props, forwardedRef) {
    var _slots$root;
    const {
        defaultValue,
        children,
...
true
  ? (FormControl.propTypes = {
       ...
       */
      children: import_prop_types5.default.oneOfType([
      ...
      slotProps: import_prop_types5.default.shape({
        root: import_prop_types5.default.oneOfType([
          import_prop_types5.default.func,
...
var inputClasses = generateUtilityClasses2(COMPONENT_NAME4, [
  "root",
  "formControl",
  "focused",
  "disabled",
...
function useInput(parameters = {}) {
  ...
  const { current: isControlled } = React12.useRef(value != null);
...
var Input = React13.forwardRef(function Input2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime8.jsxs)(
    ...
    _extends({}, rootProps, {
      children: [
        startAdornment,
        (0, import_jsx_runtime7.jsx)(InputComponent, _extends({}, inputProps)),
        endAdornment,
      ],
    }),
  );
...
true
  ? (Input.propTypes = {
       ...
       * @ignore
       */
      inputRef: import_prop_types6.default.oneOfType([
      ...
      slotProps: import_prop_types6.default.shape({
        input: import_prop_types6.default.oneOfType([
          import_prop_types6.default.func,
       ...
       * @default 'text'
       */
      type: import_prop_types6.default.oneOf([
        "button",
        "checkbox",
        "color",
        "date",
...
var menuClasses = generateUtilityClasses2(COMPONENT_NAME5, [
  "root",
  "listbox",
  "expanded",
]);
...
function handleTextNavigation(state, searchString, context) {
  const { items, isItemDisabled, disabledItemsFocusable, getItemAsString } =
    context;
...
var defaultItemStringifier = (item) =>
...
function useList(params) {
  ...
  const handleHighlightChange = React15.useCallback(
    (event, value, reason) => {
  ...
  const handleStateChange = React15.useCallback(
  ...
  const getItemState = React15.useCallback(
    (item) => {
      const selected = (selectedValues != null ? selectedValues : []).some(
        (value) => value != null && itemComparer(item, value),
      );
      const highlighted =
        highlightedValue != null && itemComparer(item, highlightedValue);
...
function useListItem(parameters) {
  ...
  const createHandleClick = React17.useCallback(
  ...
  const createHandlePointerOver = React17.useCallback(
    (externalHandlers) => (event) => {
...
function useCompoundParent() {
  ...
  const registerItem = React18.useCallback(
    function registerItem2(id, item) {
  ...
  const sortedSubitems = React18.useMemo(
    () => sortSubitems(subitems),
    [subitems],
  );
  const getItemIndex = React18.useCallback(
...
function useCompoundItem(id, itemMetadata) {
  ...
  const [registeredId, setRegisteredId] = React19.useState(
    typeof id === "function" ? void 0 : id,
  );
  useEnhancedEffect_default(() => {
...
function useMenu(parameters = {}) {
  ...
  const isItemDisabled = React20.useCallback(
    (id) => {
      var _subitems$get2;
      return (
...
function computeCoordsFromPlacement(_ref, placement, rtl) {
  let { reference: reference2, floating } = _ref;
...
var computePosition = async (reference2, floating, config) => {
  ...
  for (let i = 0; i < validMiddleware.length; i++) {
    const { name, fn: fn2 } = validMiddleware[i];
    const {
      x: nextX,
      y: nextY,
      data,
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] =
    React25.useState(true);
  ...
  React25.useEffect(() => {
    if (
      !requestEnter && // checking registeredTransitions.current instead of hasTransition to avoid this effect re-firing whenever hasTransition changes
...
var Popup = React27.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const {
    ...
    middleware:
      middleware != null
        ? middleware
        : [offset3(offsetProp != null ? offsetProp : 0), flip3(), shift3()],
    placement,
    strategy,
...
true
  ? (Popup.propTypes = {
       ...
       */
      anchor: import_prop_types7.default.oneOfType([
        HTMLElementType,
       ...
       */
      middleware: import_prop_types7.default.arrayOf(
        import_prop_types7.default.oneOfType([
          import_prop_types7.default.oneOf([false]),
       ...
       */
      offset: import_prop_types7.default.oneOfType([
        import_prop_types7.default.func,
       ...
       */
      placement: import_prop_types7.default.oneOf([
        "bottom-end",
        "bottom-start",
        "bottom",
        "left-end",
...
true
  ? (Menu.propTypes = {
       ...
       */
      anchor: import_prop_types8.default.oneOfType([
        HTMLElementType,
      ...
      slotProps: import_prop_types8.default.shape({
        listbox: import_prop_types8.default.oneOfType([
          import_prop_types8.default.func,
          import_prop_types8.default.object,
        ]),
...
function useMenuButton(parameters = {}) {
  ...
  const getRootProps = (externalProps = {}) => {
    const externalEventHandlers = extractEventHandlers(externalProps);
    const getCombinedProps = combineHooksSlotProps(
      getOwnRootProps,
      getButtonRootProps,
    );
    return _extends(
...
var menuButtonClasses = generateUtilityClasses2(COMPONENT_NAME7, [
  "root",
  "active",
  "disabled",
  "expanded",
...
var useUtilityClasses7 = (ownerState) => {
  ...
  return composeClasses(
    slots,
    useClassNamesOverride(getMenuButtonUtilityClass),
  );
};
...
true
  ? (MenuButton.propTypes = {
      ...
      slotProps: import_prop_types9.default.shape({
        root: import_prop_types9.default.oneOfType([
...
var menuItemClasses = generateUtilityClasses2(COMPONENT_NAME8, [
  "root",
  "disabled",
  "focusVisible",
]);
...
function useMenuItem(params) {
  ...
  const { dispatch } =
    (_React$useContext = React31.useContext(DropdownContext)) != null
      ? _React$useContext
  ...
  const { index: index2, totalItemCount } = useCompoundItem(
...
function useMenuItemContextStabilizer(id) {
  ...
  const localGetItemState = React32.useCallback(
    (itemValue) => {
      if (itemValue !== itemId) {
        throw new Error(
          [
...
var InnerMenuItem = React33.memo(
  React33.forwardRef(function MenuItem(props, forwardedRef) {
    var _slots$root;
    const {
        children,
        disabled: disabledProp = false,
...
true
  ? (MenuItem2.propTypes = {
      ...
      slotProps: import_prop_types10.default.shape({
        root: import_prop_types10.default.oneOfType([
...
var modalClasses = generateUtilityClasses2(COMPONENT_NAME9, [
  "root",
  "hidden",
  "backdrop",
]);
...
var Modal = React34.forwardRef(function Modal2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime14.jsx)(Portal, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime15.jsxs)(
      Root,
      _extends({}, rootProps, {
        children: [
          !hideBackdrop && BackdropComponent
            ...
            : null,
          (0, import_jsx_runtime14.jsx)(FocusTrap, {
            disableEnforceFocus,
            disableAutoFocus,
            disableRestoreFocus,
...
true
  ? (Modal.propTypes = {
       ...
       */
      container: import_prop_types11.default.oneOfType([
        HTMLElementType,
      ...
      slotProps: import_prop_types11.default.shape({
        backdrop: import_prop_types11.default.oneOfType([
          import_prop_types11.default.func,
          import_prop_types11.default.object,
        ]),
        root: import_prop_types11.default.oneOfType([
          import_prop_types11.default.func,
          import_prop_types11.default.object,
        ]),
      }),
...
var numberInputClasses = generateUtilityClasses2(COMPONENT_NAME10, [
  "root",
  "formControl",
  "focused",
  "disabled",
...
function clampStepwise(
  ...
  if (Math.abs(remainder) > step / 2) {
    return clamp_default(
      val + positivity * (step - Math.abs(remainder)),
      min3,
      max3,
    );
  }
...
function getClampedValues(rawValue, context) {
  const { min: min3, max: max3, step } = context;
  const clampedValue =
    rawValue === null ? null : clampStepwise(rawValue, min3, max3, step);
...
function stepValue(state, context, direction, multiplier) {
  const { value } = state;
  const { step = 1, min: min3, max: max3 } = context;
  if (isNumber(value)) {
    return {
...
function handleClamp(state, context, inputValue) {
  const { getInputValueAsString: getInputValueAsString2 } = context;
...
function useNumberInput(parameters) {
  ...
  const formControlContext = useFormControlContext();
  const { current: isControlled } = React36.useRef(valueProp != null);
  ...
  const handleStateChange = React36.useCallback(
  ...
  const initialValue =
    (_ref = valueProp != null ? valueProp : defaultValueProp) != null
      ? _ref
      : null;
  const initialState = {
    value: initialValue,
  ...
  const getInputProps = (externalProps = {}) => {
    ...
    const displayValue =
      (_ref2 = focused ? inputValue : value) != null ? _ref2 : "";
  ...
  const isIncrementDisabled =
    disabledProp ||
    (isNumber(value)
      ? value >= (max3 != null ? max3 : Number.MAX_SAFE_INTEGER)
      : false);
  ...
  const isDecrementDisabled =
    disabledProp ||
    (isNumber(value)
      ? value <= (min3 != null ? min3 : Number.MIN_SAFE_INTEGER)
      : false);
...
var useUtilityClasses10 = (ownerState) => {
  ...
  return composeClasses(
    slots,
    useClassNamesOverride(getNumberInputUtilityClass),
  );
};
var NumberInput = React37.forwardRef(
  function NumberInput2(props, forwardedRef) {
    ...
    const IncrementButton =
      (_slots$incrementButto = slots.incrementButton) != null
        ? _slots$incrementButto
        : "button";
    ...
    const DecrementButton =
      (_slots$decrementButto = slots.decrementButton) != null
        ? _slots$decrementButto
        : "button";
      ...
      _extends({}, rootProps, {
        children: [
          (0, import_jsx_runtime17.jsx)(
            DecrementButton,
            _extends({}, decrementButtonProps),
          ),
          (0, import_jsx_runtime17.jsx)(
            IncrementButton,
            _extends({}, incrementButtonProps),
          ),
          startAdornment,
          (0, import_jsx_runtime17.jsx)(Input3, _extends({}, inputProps)),
          endAdornment,
        ],
      }),
    );
...
true
  ? (NumberInput.propTypes = {
      ...
      slotProps: import_prop_types13.default.shape({
        decrementButton: import_prop_types13.default.oneOfType([
          import_prop_types13.default.func,
          import_prop_types13.default.object,
        ]),
        incrementButton: import_prop_types13.default.oneOfType([
          import_prop_types13.default.func,
          import_prop_types13.default.object,
        ]),
        input: import_prop_types13.default.oneOfType([
          import_prop_types13.default.func,
          import_prop_types13.default.object,
        ]),
        root: import_prop_types13.default.oneOfType([
          import_prop_types13.default.func,
          import_prop_types13.default.object,
        ]),
      }),
...
var optionGroupClasses = generateUtilityClasses2(COMPONENT_NAME11, [
  "root",
  "disabled",
  "label",
  "list",
...
var OptionGroup = React38.forwardRef(
  function OptionGroup2(props, forwardedRef) {
...
true
  ? (OptionGroup.propTypes = {
      ...
      slotProps: import_prop_types14.default.shape({
        label: import_prop_types14.default.oneOfType([
          import_prop_types14.default.func,
          import_prop_types14.default.object,
        ]),
        list: import_prop_types14.default.oneOfType([
          import_prop_types14.default.func,
          import_prop_types14.default.object,
        ]),
        root: import_prop_types14.default.oneOfType([
          import_prop_types14.default.func,
          import_prop_types14.default.object,
        ]),
      }),
...
var optionClasses = generateUtilityClasses2(COMPONENT_NAME12, [
  "root",
  "disabled",
  "selected",
  "highlighted",
...
function useOption(params) {
  ...
  const { index: index2 } = useCompoundItem(value, selectOption);
...
function useOptionContextStabilizer(value) {
  ...
  const localGetItemState = React40.useCallback(
    (itemValue) => {
      if (itemValue !== value) {
        throw new Error(
          [
...
var InnerOption = React41.memo(
  React41.forwardRef(function Option(props, forwardedRef) {
...
true
  ? (Option2.propTypes = {
      ...
      slotProps: import_prop_types15.default.shape({
        root: import_prop_types15.default.oneOfType([
...
var placements2 = [].concat(basePlacements, [auto]).reduce(function (
  acc,
  placement,
) {
  return acc.concat([
...
function getBoundingClientRect2(element, includeScale, isFixedStrategy) {
  ...
  var _ref = isElement2(element) ? getWindow2(element) : window,
...
function getContainingBlock2(element) {
  ...
  while (
    ...
    ["html", "body"].indexOf(getNodeName2(currentNode)) < 0
  ) {
...
function getOffsetParent2(element) {
  ...
  if (
    offsetParent &&
    (getNodeName2(offsetParent) === "html" ||
      (getNodeName2(offsetParent) === "body" &&
        getComputedStyle2(offsetParent).position === "static"))
  ) {
    return window2;
  }
...
function arrow3(_ref) {
  ...
  state.modifiersData[name] =
    ...
    (_state$modifiersData$[axisProp] = offset5),
    (_state$modifiersData$.centerOffset = offset5 - center),
    _state$modifiersData$);
}
...
function getWindowScrollBarX2(element) {
  return (
    getBoundingClientRect2(getDocumentElement2(element)).left +
...
function getClientRectFromMixedType(element, clippingParent, strategy) {
  return clippingParent === viewport
    ? rectToClientRect2(getViewportRect2(element, strategy))
    : isElement2(clippingParent)
      ? getInnerBoundingClientRect2(clippingParent, strategy)
      : rectToClientRect2(getDocumentRect2(getDocumentElement2(element)));
}
function getClippingParents(element) {
  ...
  return clippingParents2.filter(function (clippingParent) {
    return (
      ...
      getNodeName2(clippingParent) !== "body"
    );
  });
}
...
function detectOverflow3(state, options) {
  ...
  var clippingClientRect = getClippingRect2(
    isElement2(element)
      ? element
      : element.contextElement || getDocumentElement2(state.elements.popper),
    boundary,
    rootBoundary,
    strategy,
  );
  ...
  var popperClientRect = rectToClientRect2(
...
function computeAutoPlacement(state, options) {
  ...
  var _options = options,
    ...
    allowedAutoPlacements =
      _options$allowedAutoP === void 0 ? placements2 : _options$allowedAutoP;
  var variation = getVariation(placement);
  var placements3 = variation
    ? flipVariations
      ? variationPlacements
...
function flip4(_ref) {
  ...
  var fallbackPlacements =
    ...
    (isBasePlacement || !flipVariations
      ? [getOppositePlacement2(preferredPlacement)]
      : getExpandedFallbackPlacements(preferredPlacement));
  var placements3 = [preferredPlacement]
...
function offset4(_ref2) {
  ...
  var _options$offset = options.offset,
    offset5 = _options$offset === void 0 ? [0, 0] : _options$offset;
...
function preventOverflow(_ref) {
  ...
  if (checkMainAxis) {
    ...
    var arrowOffsetParent =
      state.elements.arrow && getOffsetParent2(state.elements.arrow);
...
function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
  ...
  var rect = getBoundingClientRect2(
  ...
  if (isOffsetParentAnElement || (!isOffsetParentAnElement && !isFixed)) {
    if (
      getNodeName2(offsetParent) !== "body" || // https://github.com/popperjs/popper-core/issues/1078
  ...
  return function createPopper4(reference2, popper2, options) {
    ...
    var instance = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        state.scrollParents = {
          reference: isElement2(reference2)
...
var PopperTooltip = React42.forwardRef(
  function PopperTooltip2(props, forwardedRef) {
    var _slots$root;
    const {
        anchorEl,
        children,
    ...
    const [resolvedAnchorElement, setResolvedAnchorElement] = React42.useState(
    ...
    useEnhancedEffect_default(() => {
      ...
      if (true) {
        if (
          ...
          isHTMLElement3(resolvedAnchorElement) &&
...
var Popper = React42.forwardRef(function Popper2(props, forwardedRef) {
  ...
  if (containerProp) {
    ...
    container =
      resolvedAnchorEl && isHTMLElement3(resolvedAnchorEl)
...
true
  ? (Popper.propTypes = {
      ...
      anchorEl: chainPropTypes(
        ...
        (props) => {
          if (props.open) {
            ...
            if (
              resolvedAnchorEl &&
              isHTMLElement3(resolvedAnchorEl) &&
       ...
       */
      children: import_prop_types16.default.oneOfType([
        import_prop_types16.default.node,
        import_prop_types16.default.func,
      ]),
      /**
       * An HTML element or function that returns one.
       ...
       * so it's simply `document.body` most of the time.
       */
      container: import_prop_types16.default.oneOfType([
        HTMLElementType,
        import_prop_types16.default.func,
      ]),
      /**
       ...
       */
      modifiers: import_prop_types16.default.arrayOf(
        import_prop_types16.default.shape({
          ...
          phase: import_prop_types16.default.oneOf([
            "afterMain",
            "afterRead",
            "afterWrite",
            "beforeMain",
          ...
          requires: import_prop_types16.default.arrayOf(
            import_prop_types16.default.string,
          ),
          requiresIfExists: import_prop_types16.default.arrayOf(
            import_prop_types16.default.string,
          ),
        }),
      ),
       ...
       * @default 'bottom'
       */
      placement: import_prop_types16.default.oneOf([
        "auto-end",
        "auto-start",
        "auto",
        "bottom-end",
      ...
      slotProps: import_prop_types16.default.shape({
        root: import_prop_types16.default.oneOfType([
          import_prop_types16.default.func,
          import_prop_types16.default.object,
        ]),
      }),
...
function useSelect(props) {
  ...
  const options = React43.useMemo(() => {
    if (optionsParam != null) {
      return new Map(
        optionsParam.map((option, index2) => [
          option.value,
          {
            value: option.value,
            label: option.label,
  ...
  const optionValues = React43.useMemo(
    () => Array.from(options.keys()),
    [options],
  );
  const getOptionByValue = React43.useCallback(
    (valueToGet) => {
  ...
  const isItemDisabled = React43.useCallback(
    (valueToCheck) => {
  ...
  const stringifyOption = React43.useCallback(
    (valueToCheck) => {
      const option = getOptionByValue(valueToCheck);
      if (!option) {
        return "";
  ...
  const getItemId = React43.useCallback(
    (itemValue) => {
      var _options$get;
  ...
  const handleSelectionChange = React43.useCallback(
    (event, newValues) => {
      if (multiple) {
  ...
  const handleHighlightChange = React43.useCallback(
    (event, newValue) => {
  ...
  const handleStateChange = React43.useCallback(
    (event, field, fieldValue) => {
      if (field === "open") {
        onOpenChange == null || onOpenChange(fieldValue);
        if (
          fieldValue === false &&
          (event == null ? void 0 : event.type) !== "blur"
        ) {
  ...
  const getItemDomElement = React43.useCallback(
    (itemId) => {
      var _subitems$get$ref$cur, _subitems$get;
      if (itemId == null) {
        return null;
  ...
  const getOptionMetadata = React43.useCallback(
  ...
  if (multiple) {
    ...
    selectedOptionsMetadata =
      (_getOptionMetadata = getOptionMetadata(selectValue)) != null
        ? _getOptionMetadata
        : null;
  }
...
var selectClasses = generateUtilityClasses2(COMPONENT_NAME14, [
  "root",
  "button",
  "listbox",
  "popup",
...
var Select = React45.forwardRef(function Select2(props, forwardedRef) {
  ...
  const PopupComponent =
    (_slots$popup = slots.popup) != null ? _slots$popup : "div";
          ...
          children:
            (_ref =
              ...
              : // fall back to a zero-width space to prevent layout shift
                ...
                _span ||
                (_span = (0, import_jsx_runtime24.jsx)("span", {
...
true
  ? (Select.propTypes = {
      ...
      slotProps: import_prop_types17.default.shape({
        listbox: import_prop_types17.default.oneOfType([
          import_prop_types17.default.func,
          import_prop_types17.default.object,
        ]),
        popup: import_prop_types17.default.oneOfType([
          import_prop_types17.default.func,
          import_prop_types17.default.object,
        ]),
        root: import_prop_types17.default.oneOfType([
          import_prop_types17.default.func,
          import_prop_types17.default.object,
        ]),
      }),
...
var sliderClasses = generateUtilityClasses2(COMPONENT_NAME15, [
  "root",
  "active",
  "focusVisible",
  "disabled",
...
function useSlider(parameters) {
  ...
  values = values.map((value) =>
    value == null ? min3 : clamp_default(value, min3, max3),
  );
  const marks =
    marksProp === true && step !== null
      ? [...Array(Math.floor((max3 - min3) / step) + 1)].map((_, index2) => ({
  ...
  const changeValue = (event, valueInput) => {
    ...
    if (range) {
      if (disableSwap) {
        newValue = clamp_default(
          newValue,
          values[index2 - 1] || -Infinity,
          values[index2 + 1] || Infinity,
        );
      }
  ...
  const trackLeap =
    valueToPercent(values[values.length - 1], min3, max3) - trackOffset;
  const getRootProps = (externalProps = {}) => {
...
var Slider = React47.forwardRef(function Slider2(props, forwardedRef) {
  ...
  const MarkLabel =
    (_slots$markLabel = slots.markLabel) != null ? _slots$markLabel : "span";
  ...
  return (0, import_jsx_runtime27.jsxs)(
    ...
    _extends({}, rootProps, {
      children: [
        (0, import_jsx_runtime26.jsx)(Rail, _extends({}, railProps)),
        (0, import_jsx_runtime26.jsx)(Track, _extends({}, trackProps)),
        marks
          .filter((mark) => mark.value >= min3 && mark.value <= max3)
          .map((mark, index2) => {
        ...
        values.map((value, index2) => {
          ...
          const style = axisProps2[axis].offset(percent);
          const resolvedSlotProps = resolveComponentProps(
            slotProps.thumb,
            ownerState,
            {
              index: index2,
            ...
            _extends(
              ...
              resolvedSlotProps,
              {
                className: clsx_default(
                  ...
                  resolvedSlotProps == null
                    ? void 0
                    : resolvedSlotProps.className,
                  active === index2 && classes.active,
                  focusedThumbIndex === index2 && classes.focusVisible,
                ),
                style: _extends(
                  {},
                  style,
                    ...
                    _extends(
                      {
                        ...
                        "aria-valuetext": getAriaValueText
                          ? getAriaValueText(scale(value), index2)
                          : ariaValuetext,
                        value: values[index2],
                      },
                      inputProps,
                          ...
                          valueLabelProps,
                          {
                            children:
                              typeof valueLabelFormat === "function"
                                ? valueLabelFormat(scale(value), index2)
                                : valueLabelFormat,
                          },
                        ),
                      )
...
true
  ? (Slider.propTypes = {
       ...
       * The default value. Use when the component is not controlled.
       */
      defaultValue: import_prop_types18.default.oneOfType([
        import_prop_types18.default.arrayOf(import_prop_types18.default.number),
       ...
       * @default false
       */
      marks: import_prop_types18.default.oneOfType([
       ...
       * @default 'horizontal'
       */
      orientation: import_prop_types18.default.oneOf([
        "horizontal",
        "vertical",
      ]),
      /**
      ...
      slotProps: import_prop_types18.default.shape({
        input: import_prop_types18.default.oneOfType([
          import_prop_types18.default.func,
          import_prop_types18.default.object,
        ]),
        mark: import_prop_types18.default.oneOfType([
          import_prop_types18.default.func,
          import_prop_types18.default.object,
        ]),
        markLabel: import_prop_types18.default.oneOfType([
          import_prop_types18.default.func,
          import_prop_types18.default.object,
        ]),
        rail: import_prop_types18.default.oneOfType([
          import_prop_types18.default.func,
          import_prop_types18.default.object,
        ]),
        root: import_prop_types18.default.oneOfType([
          import_prop_types18.default.func,
          import_prop_types18.default.object,
        ]),
        thumb: import_prop_types18.default.oneOfType([
          import_prop_types18.default.func,
          import_prop_types18.default.object,
        ]),
        track: import_prop_types18.default.oneOfType([
          import_prop_types18.default.func,
          import_prop_types18.default.object,
        ]),
        valueLabel: import_prop_types18.default.oneOfType([
          import_prop_types18.default.any,
          import_prop_types18.default.func,
        ]),
      }),
      /**
       ...
       */
      value: import_prop_types18.default.oneOfType([
        import_prop_types18.default.arrayOf(import_prop_types18.default.number),
        import_prop_types18.default.number,
      ]),
      /**
       ...
       * }
       */
      valueLabelFormat: import_prop_types18.default.oneOfType([
        import_prop_types18.default.func,
        import_prop_types18.default.string,
      ]),
    })
...
true
  ? (Snackbar.propTypes = {
      ...
      slotProps: import_prop_types19.default.shape({
        clickAwayListener: import_prop_types19.default.oneOfType([
          ...
          import_prop_types19.default.shape({
            ...
            mouseEvent: import_prop_types19.default.oneOf([
              "onClick",
              "onMouseDown",
              "onMouseUp",
              "onPointerDown",
            ...
            touchEvent: import_prop_types19.default.oneOf([
              "onTouchEnd",
              "onTouchStart",
              false,
            ]),
        ...
        root: import_prop_types19.default.oneOfType([
          import_prop_types19.default.func,
...
var switchClasses = generateUtilityClasses2(COMPONENT_NAME17, [
  "root",
  "input",
  "track",
  "thumb",
...
var Switch = React51.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime30.jsxs)(
    ...
    _extends({}, rootProps, {
      children: [
        (0, import_jsx_runtime29.jsx)(Track, _extends({}, trackProps)),
        (0, import_jsx_runtime29.jsx)(Thumb, _extends({}, thumbProps)),
        (0, import_jsx_runtime29.jsx)(Input3, _extends({}, inputProps)),
      ],
    }),
  );
});
true
  ? (Switch.propTypes = {
      ...
      slotProps: import_prop_types20.default.shape({
        input: import_prop_types20.default.oneOfType([
          import_prop_types20.default.func,
          import_prop_types20.default.object,
        ]),
        root: import_prop_types20.default.oneOfType([
          import_prop_types20.default.func,
          import_prop_types20.default.object,
        ]),
        thumb: import_prop_types20.default.oneOfType([
          import_prop_types20.default.func,
          import_prop_types20.default.object,
        ]),
        track: import_prop_types20.default.oneOfType([
          import_prop_types20.default.func,
          import_prop_types20.default.object,
        ]),
      }),
      ...
      slots: import_prop_types20.default.shape({
        ...
        track: import_prop_types20.default.oneOfType([
          import_prop_types20.default.elementType,
          import_prop_types20.default.oneOf([null]),
        ]),
      }),
    })
  : void 0;
...
function LastPageIconDefault() {
  return (
    _span2 ||
    (_span2 = (0, import_jsx_runtime31.jsx)("span", {
      children: "⇾|",
    }))
  );
}
function FirstPageIconDefault() {
  return (
    _span22 ||
    (_span22 = (0, import_jsx_runtime31.jsx)("span", {
      children: "|⇽",
    }))
  );
}
function NextPageIconDefault() {
  return (
    _span3 ||
    (_span3 = (0, import_jsx_runtime31.jsx)("span", {
      children: "⇾",
    }))
  );
}
function BackPageIconDefault() {
  return (
    _span4 ||
    (_span4 = (0, import_jsx_runtime31.jsx)("span", {
      children: "⇽",
    }))
  );
}
...
var TablePaginationActions = React52.forwardRef(
  function TablePaginationActions2(props, forwardedRef) {
    var _slots$root,
      _slots$firstButton,
      _slots$lastButton,
      _slots$nextButton,
          ...
          showFirstButton &&
            (0, import_jsx_runtime31.jsx)(
              ...
              _extends({}, firstButtonProps, {
                children:
                  direction === "rtl"
                    ? (0, import_jsx_runtime31.jsx)(LastPageIcon, {})
                    : (0, import_jsx_runtime31.jsx)(FirstPageIcon, {}),
              }),
            ),
          (0, import_jsx_runtime31.jsx)(
            BackButton,
            _extends({}, backButtonProps, {
              children:
                direction === "rtl"
                  ? (0, import_jsx_runtime31.jsx)(NextPageIcon, {})
                  : (0, import_jsx_runtime31.jsx)(BackPageIcon, {}),
            }),
          ),
          (0, import_jsx_runtime31.jsx)(
            NextButton,
...
var tablePaginationClasses = generateUtilityClasses2(COMPONENT_NAME18, [
  "root",
  "toolbar",
  "spacer",
  "selectLabel",
...
var TablePagination = React53.forwardRef(
  function TablePagination2(props, forwardedRef) {
    var _slots$root,
      _slots$select,
      _slots$actions,
      _slots$menuItem,
    ...
    return (0, import_jsx_runtime33.jsx)(
      Root,
      _extends({}, rootProps, {
        children: (0, import_jsx_runtime34.jsxs)(
          Toolbar,
          _extends({}, toolbarProps, {
            children: [
              (0, import_jsx_runtime33.jsx)(Spacer, _extends({}, spacerProps)),
...
true
  ? (TablePagination.propTypes = {
       ...
       */
      rowsPerPageOptions: import_prop_types21.default.arrayOf(
      ...
      slotProps: import_prop_types21.default.shape({
        actions: import_prop_types21.default.oneOfType([
          import_prop_types21.default.func,
          import_prop_types21.default.object,
        ]),
        displayedRows: import_prop_types21.default.oneOfType([
          import_prop_types21.default.func,
          import_prop_types21.default.object,
        ]),
        menuItem: import_prop_types21.default.oneOfType([
          import_prop_types21.default.func,
          import_prop_types21.default.object,
        ]),
        root: import_prop_types21.default.oneOfType([
          import_prop_types21.default.func,
          import_prop_types21.default.object,
        ]),
        select: import_prop_types21.default.oneOfType([
          import_prop_types21.default.func,
          import_prop_types21.default.object,
        ]),
        selectLabel: import_prop_types21.default.oneOfType([
          import_prop_types21.default.func,
          import_prop_types21.default.object,
        ]),
        spacer: import_prop_types21.default.oneOfType([
          import_prop_types21.default.func,
          import_prop_types21.default.object,
        ]),
        toolbar: import_prop_types21.default.oneOfType([
          import_prop_types21.default.func,
          import_prop_types21.default.object,
        ]),
      }),
...
var tabPanelClasses = generateUtilityClasses2(COMPONENT_NAME19, [
  "root",
  "hidden",
]);
...
var tabsClasses = generateUtilityClasses2(COMPONENT_NAME20, [
  "root",
  "horizontal",
  "vertical",
]);
...
function useTabs(parameters) {
  ...
  const onSelected = React54.useCallback(
    (event, newValue) => {
      setValue(newValue);
  ...
  const getTabPanelId = React54.useCallback(
    (tabValue) => {
      var _tabPanels$get;
      return (_tabPanels$get = tabPanels.get(tabValue)) == null
        ? void 0
        : _tabPanels$get.id;
    },
    [tabPanels],
...
true
  ? (Tabs.propTypes = {
       ...
       * The default value. Use when the component is not controlled.
       */
      defaultValue: import_prop_types22.default.oneOfType([
       ...
       * @default 'horizontal'
       */
      orientation: import_prop_types22.default.oneOf([
        "horizontal",
        "vertical",
      ]),
      /**
      ...
      slotProps: import_prop_types22.default.shape({
        root: import_prop_types22.default.oneOfType([
       ...
       */
      value: import_prop_types22.default.oneOfType([
        import_prop_types22.default.number,
        import_prop_types22.default.string,
      ]),
    })
...
true
  ? (TabPanel.propTypes = {
      ...
      slotProps: import_prop_types23.default.shape({
        root: import_prop_types23.default.oneOfType([
       ...
       */
      value: import_prop_types23.default.oneOfType([
...
var tabsListClasses = generateUtilityClasses2(COMPONENT_NAME21, [
  "root",
  "horizontal",
  "vertical",
]);
...
function useTabsList(parameters) {
  ...
  const { subitems, contextValue: compoundComponentContextValue } =
    useCompoundParent();
  const tabIdLookup = React60.useCallback(
    (tabValue) => {
      var _subitems$get;
  ...
  const subitemKeys = React60.useMemo(
    () => Array.from(subitems.keys()),
    [subitems],
  );
  const getTabElement = React60.useCallback(
    (tabValue) => {
  ...
  const handleChange = React60.useCallback(
    (event, newValue) => {
      var _newValue$;
  ...
  const isItemDisabled = React60.useCallback(
    (item) => {
...
true
  ? (TabsList.propTypes = {
      ...
      slotProps: import_prop_types24.default.shape({
        root: import_prop_types24.default.oneOfType([
...
var tabClasses = generateUtilityClasses2(COMPONENT_NAME22, [
  "root",
  "selected",
  "disabled",
]);
...
true
  ? (Tab.propTypes = {
       ...
       * A ref for imperative actions. It currently only supports `focusVisible()` action.
       */
      action: import_prop_types25.default.oneOfType([
...
var TextareaAutosize = React65.forwardRef(
  function TextareaAutosize2(props, forwardedRef) {
    const { onChange, maxRows, minRows = 1, style, value } = props,
      other = _objectWithoutPropertiesLoose(props, _excluded25);
    const { current: isControlled } = React65.useRef(value != null);
    ...
    useEnhancedEffect_default(() => {
      ...
      if (typeof ResizeObserver !== "undefined") {
        resizeObserver = new ResizeObserver(
          false ? rAFHandleResize : handleResize,
        );
    ...
    return (0, import_jsx_runtime42.jsxs)(React65.Fragment, {
      children: [
        ...
        (0, import_jsx_runtime41.jsx)("textarea", {
          "aria-hidden": true,
...
true
  ? (TextareaAutosize.propTypes = {
       ...
       */
      maxRows: import_prop_types26.default.oneOfType([
        import_prop_types26.default.number,
       ...
       * @default 1
       */
      minRows: import_prop_types26.default.oneOfType([
        import_prop_types26.default.number,
        import_prop_types26.default.string,
      ]),
      /**
       ...
       * @ignore
       */
      value: import_prop_types26.default.oneOfType([
        import_prop_types26.default.arrayOf(import_prop_types26.default.string),
        import_prop_types26.default.number,
        import_prop_types26.default.string,
      ]),
    })
...
function CssAnimation(props) {
  ...
  const handleAnimationEnd = React66.useCallback(
    (event) => {
    ...
    _extends(
      {
        ...
        className: clsx_default(
          className,
          requestedEnter ? enterClassName : exitClassName,
        ),
      },
      other,
      {
...
var CssTransition = React67.forwardRef(
  function CssTransition2(props, forwardedRef) {
    const {
        children,
        className,
        lastTransitionedPropertyOnExit,
    ...
    const handleTransitionEnd = React67.useCallback(
      (event) => {
        if (
          !requestedEnter &&
      ...
      _extends(
        {
          ...
          className: clsx_default(
            className,
            isEntering ? enterClassName : exitClassName,
          ),
        },
        other,
        {
...
function useAutocomplete(props) {
  ...
  const resetInputValue = React68.useCallback(
    (event, newValue) => {
  ...
  const setHighlightedIndex = useEventCallback_default(
    ({ event, index: index2, reason = "auto" }) => {
      ...
      if (onHighlightChange) {
        onHighlightChange(
          event,
          index2 === -1 ? null : filteredOptions[index2],
          reason,
        );
      }
  ...
  return {
    ...
    getOptionProps: ({ index: index2, option }) => {
      ...
      return {
        key:
          (_getOptionKey =
            getOptionKey == null ? void 0 : getOptionKey(option)) != null
            ? _getOptionKey
            : getOptionLabel(option),
        tabIndex: -1,
        role: "option",
...
true
  ? (GlobalStyles.propTypes = {
       ...
       */
      styles: import_prop_types29.default.oneOfType([
        import_prop_types29.default.array,
        import_prop_types29.default.func,
        import_prop_types29.default.number,
...
function isFilled(obj, SSR = false) {
  return (
    obj &&
    ((hasValue2(obj.value) && obj.value !== "") ||
      (SSR && hasValue2(obj.defaultValue) && obj.defaultValue !== ""))
  );
}
...
var rootOverridesResolver = (props, styles2) => {
  ...
  return [
    ...
    ownerState.color && styles2[`color${capitalize_default(ownerState.color)}`],
...
var useUtilityClasses23 = (ownerState) => {
  ...
  const slots = {
    root: [
      ...
      size3 && size3 !== "medium" && `size${capitalize_default(size3)}`,
      multiline && "multiline",
...
var InputBase = React72.forwardRef(function InputBase2(inProps, ref) {
  ...
  const { current: isControlled } = React72.useRef(value != null);
  ...
  const handleInputRef = useForkRef_default(
    inputRef,
    inputRefProp,
    inputPropsProp.ref,
    handleInputRefWarning,
  ...
  const checkDirty = React72.useCallback(
    (obj) => {
      if (isFilled(obj)) {
        if (onFilled) {
          onFilled();
...
true
  ? (InputBase.propTypes = {
       ...
       */
      color: import_prop_types30.default.oneOfType([
        import_prop_types30.default.oneOf([
          "primary",
          "secondary",
          "error",
          "info",
       ...
       * Maximum number of rows to display when multiline option is set to true.
       */
      maxRows: import_prop_types30.default.oneOfType([
        import_prop_types30.default.number,
        import_prop_types30.default.string,
      ]),
      /**
       * Minimum number of rows to display when multiline option is set to true.
       */
      minRows: import_prop_types30.default.oneOfType([
        import_prop_types30.default.number,
        import_prop_types30.default.string,
      ]),
      /**
       ...
       * Number of rows to display when multiline option is set to true.
       */
      rows: import_prop_types30.default.oneOfType([
        import_prop_types30.default.number,
        import_prop_types30.default.string,
      ]),
      /**
      ...
      size: import_prop_types30.default.oneOfType([
        import_prop_types30.default.oneOf(["medium", "small"]),
        import_prop_types30.default.string,
      ]),
      /**
       * The extra props for the slot components.
       ...
       */
      sx: import_prop_types30.default.oneOfType([
        import_prop_types30.default.arrayOf(
          import_prop_types30.default.oneOfType([
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OBF7E2BQ.js.map
