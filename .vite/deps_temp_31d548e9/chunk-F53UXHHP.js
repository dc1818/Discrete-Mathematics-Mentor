import { TransitionGroup_default } from "./chunk-FJTIQE5L.js";
import {
  init_useEventCallback,
  init_useIsFocusVisible,
  useEventCallback_default,
  useIsFocusVisible_default,
} from "./chunk-Z5NUF7OX.js";
...
function Ripple(props) {
  ...
  const rippleClassName = clsx_default(
    className,
    classes.ripple,
  ...
  const childClassName = clsx_default(
    classes.child,
...
var TouchRipple = React2.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const startCommit = React2.useCallback(
    (params) => {
        ...
        (0, import_jsx_runtime2.jsx)(
          TouchRippleRipple,
          {
            classes: {
              ...
              rippleVisible: clsx_default(
                classes.rippleVisible,
                touchRippleClasses_default.rippleVisible,
              ),
              ripplePulsate: clsx_default(
              ...
              childLeaving: clsx_default(
                classes.childLeaving,
                touchRippleClasses_default.childLeaving,
              ),
              childPulsate: clsx_default(
...
true
  ? (ButtonBase.propTypes = {
       ...
       */
      touchRippleRef: import_prop_types3.default.oneOfType([
        import_prop_types3.default.func,
       ...
       * @ignore
       */
      type: import_prop_types3.default.oneOfType([
        import_prop_types3.default.oneOf(["button", "reset", "submit"]),
...
//# sourceMappingURL=chunk-F53UXHHP.js.map
